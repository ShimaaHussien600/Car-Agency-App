...
public class replace_frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(instruct, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 280, 130, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background/760×490.jpg"))); // NOI18N
    ...
    private void replaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_replaceActionPerformed
        if(model.getSelectedItem().equals("")||color.getText().equals("")||year.getText().equals("")||price.getText().equals("")||table.getValueAt(table.getSelectedRow(), 3).equals("0"))
        {
