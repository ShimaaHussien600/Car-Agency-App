...
public class trader_menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        instruct.setForeground(new java.awt.Color(255, 153, 0));
        instruct.setText("Choose Operation");
        getContentPane().add(instruct, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 220, 130, 20));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/background/760×490.jpg"))); // NOI18N
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        year.setText(table.getValueAt(row, 2)+"");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        year.setEnabled(true);year.setText("");
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        year.setEnabled(false);year.setText("");
    ...
    private void opActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opActionPerformed
        if(model.getSelectedItem().equals("")||color.getText().equals("")||year.getText().equals("")||amount.getText().equals("")||price.getText().equals(""))
        {
            JOptionPane.showMessageDialog(null, "Data is Missed");
            return;
        }
        try {
            if(add.isSelected())
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(trader_menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
